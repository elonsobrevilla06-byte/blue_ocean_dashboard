...
def export_dashboard_pdf():
    ...
    # 1) TRANSACTIONS PDF
    # =====================================================
    tx_file = f"transactions_{timestamp}.pdf"
    ...
    # =====================================================
    # 2) STAFF PDF (FIXED - NO DOUBLE COUNTING)
    # =====================================================
    staff_file = f"staff_{timestamp}.pdf"
    ...
    # 3) ITEMS PDF
    # =====================================================
    items_file = f"items_{timestamp}.pdf"
